...
var formControl_dist_clPrivacyComponentsFormControl = require('../../form-control/dist/cl-privacy-components-form-control.cjs.dev.js');
...
function Select(props) {
  ...
  return /*#__PURE__*/React__namespace.createElement(formControl_dist_clPrivacyComponentsFormControl.FormControl, {
    label: label,
    error: error
  }, /*#__PURE__*/React__namespace.createElement(RawSelect // TODO
  // @ts-ignore
  , _extends._extends({
    ref: undefined
  }, restProps)));
}
const RawSelect = /*#__PURE__*/React__namespace.forwardRef((props, ref) => {
  const { ...restProps
  } = props;
  return /*#__PURE__*/React__namespace.createElement("select", _extends._extends({
    ref: ref,
    "data-ph-vars-select": "",
    "data-ph-select": "" // className={cx([
